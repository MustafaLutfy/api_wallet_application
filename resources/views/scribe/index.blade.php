    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-transfer">Store a newly created resource in storage.</a>
                            </li>
...
<div class="bash-example">
    ...
    --header "Authorization: Bearer 2|6bOenXGL27magWf12LysjzdWjuUmmzHBBpOcXPYT3ea40982"</code></pre></div>
...
&nbsp;
 &nbsp;
               ...
               value="Bearer 2|6bOenXGL27magWf12LysjzdWjuUmmzHBBpOcXPYT3ea40982"
               data-component="header">
    <br>
<p>Example: <code>Bearer 2|6bOenXGL27magWf12LysjzdWjuUmmzHBBpOcXPYT3ea40982</code></p>
            </div>
                        </form>
    ...
    &quot;wallet&quot;: [
        {
            ...
            &quot;total_income&quot;: 0,
            &quot;total_expenses&quot;: 50,
            &quot;created_at&quot;: &quot;2024-03-11T22:46:52.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2024-03-12T00:38:26.000000Z&quot;
        }
    ]
}</code>
 </pre>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization"                data-endpoint="GETapi-wallet"
               value="Bearer 2|6bOenXGL27magWf12LysjzdWjuUmmzHBBpOcXPYT3ea40982"
               data-component="header">
    <br>
<p>Example: <code>Bearer 2|6bOenXGL27magWf12LysjzdWjuUmmzHBBpOcXPYT3ea40982</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-transfer">Store a newly created resource in storage.</h2>
...
<div class="bash-example">
    ...
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --header "Authorization: Bearer 2|6bOenXGL27magWf12LysjzdWjuUmmzHBBpOcXPYT3ea40982" \
    --data "{
    \"phone\": \"ewfjbwlfjorvriyeyptuz\",
    \"amount\": \"et\",
    \"category\": \"architecto\",
    \"transfer_type\": \"amet\"
}"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization"                data-endpoint="POSTapi-transfer"
               value="Bearer 2|6bOenXGL27magWf12LysjzdWjuUmmzHBBpOcXPYT3ea40982"
               data-component="header">
    <br>
<p>Example: <code>Bearer 2|6bOenXGL27magWf12LysjzdWjuUmmzHBBpOcXPYT3ea40982</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="POSTapi-transfer"
               value="ewfjbwlfjorvriyeyptuz"
               data-component="body">
    <br>
<p>Must be at least 11 characters. Example: <code>ewfjbwlfjorvriyeyptuz</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="category"                data-endpoint="POSTapi-transfer"
               value="architecto"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="transfer_type"                data-endpoint="POSTapi-transfer"
               value="amet"
               data-component="body">
    <br>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;user&quot;: {
        ...
        &quot;created_at&quot;: &quot;2024-03-11T22:46:52.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2024-03-11T22:46:52.000000Z&quot;
    }
}</code>
 </pre>
    </span>
